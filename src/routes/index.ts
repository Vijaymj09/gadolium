...
import { SignUpWithUsernameAndPasswordError } from "../controllers/+type";
import { signUpWithUsernameAndPassword } from "../controllers";
...
hono.post("/authentication/log-in", async (context) => {
  try {
    ...
    if (e === SignUpWithUsernameAndPasswordError.INCORRECT_USERNAME_OR_PASSWORD) {
      return context.json(
        {
