...
import { type SignUpWithUsernameAndPasswordResult, SignUpWithUsernameAndPasswordError, type LogInWithUsernameAndPasswordResult, LogInWtihUsernameAndPasswordError } from "./authentication-types.ts";
